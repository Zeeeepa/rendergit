"""
Core functionality for rendergit.

This module contains the core functions for cloning repositories,
analyzing files, and generating HTML output.
"""
...
def analyze_repo(repo_url: str, max_bytes: int = MAX_DEFAULT_BYTES) -> RepoAnalysisResult:
    """
    Analyze a repository and generate HTML content.
    ...
    Returns:
        RepoAnalysisResult object containing analysis results
    """
